...
@section('page-head')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
           <a href="{{ route('payroll.shipmentItems.create') }}" id="btn-new-shipmentItems" class="btn btn-sm btn-primary">
...
<div class="card border-top border-0 border-4 border-primary">
    <div class="card-body p-4">
        ...
        {!! html()->modelForm($shipmentItem,'PUT',route('payroll.shipmentItems.update', $shipmentItem->id) )->class('form-horizontal') !!}
            ...
            <div class="col-lg-offset-3 col-lg-9">
                ...
                <a href="{{ route('payroll.shipmentItems.show', $shipmentItem->id) }}" class="btn btn-warning btn-default">Cancel</a>
            </div>
        {!! html()->form()->close() !!}                
