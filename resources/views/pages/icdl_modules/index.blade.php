...
@section('page_title_buttons')
    <a id="btn-new-mdl-icdlModule-modal" class="btn btn-sm btn-primary btn-new-mdl-customer-modal">
        <i class="fas fa-plus-square me-1"></i>New ICDL Module
    </a>
@stop
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 d-flex justify-content-end mb-4">
                    <a id="btn-new-mdl-customers-modal"
                        class="btn btn-sm btn-primary text-white btn-new-mdl-icdlModule-modal">
                        <i class="fas fa-plus-square me-1"></i>New ICDL Module
                    </a>
