    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('dashboard')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/favicon.png') }}" alt="" height="30">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('assets/images/favicon.png') }}" alt="" height="24"> <span class="logo-txt"> IBBU ICDL ATC</span>
                    </span>
                </a>
                ...
                <a href="{{route('dashboard')}}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('images/logo.png') }}" alt="" height="24"> <span class="logo-txt"> IBBU ICDL ATC</span>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{-- @if (Auth::user()->avatar != ''){{ URL::asset('images/'. Auth::user()->avatar) }}@else --}}{{ URL::asset('assets/images/user.png') }}{{-- @endif --}}" alt="Header Avatar">
